...
type SpacingType = '0' | '1' | '2' | '3' | '4' | '5' | 'auto' | 'sm-0' | 'sm-1' | 'sm-2' | 'sm-3' | 'sm-4' | 'sm-5'| 'md-0' | 'md-1' | 'md-2' | 'md-3' | 'md-4' | 'md-5' | 'lg-0' | 'lg-1' | 'lg-2' | 'lg-3' | 'lg-4' | 'lg-5'| 'xl-0' | 'xl-1' | 'xl-2' | 'xl-3' | 'xl-4' | 'xl-5'| 'xl-0' | 'xl-1' | 'xl-2' | 'xl-3' | 'xl-4' | 'xl-5'| 'xxl-0' | 'xxl-1' | 'xxl-2' | 'xxl-3' | 'xxl-4' | 'xxl-5' | 0 | 1 | 2 | 3 | 4 | 5
...
export default function manageClassNames(props: Props, ...rest: Argument[]) {
    return classnames(...rest, {
        ...
        ...spacingPrefixes.reduce((a, b) => ({
          ...a, [joinPropArray(props[b], `${b}-`)]: props[b]
        }), {}),
