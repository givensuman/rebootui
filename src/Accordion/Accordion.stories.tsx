...
import {
    type AccordionProps, type AccordionBodyProps
} from './Accordion'
...
const Template: ComponentStory<any> = (args: AccordionProps & AccordionBodyProps) => 
    <Accordion flush={args.flush}>
        <AccordionItem>
            <AccordionHeader>
                Hi mom
            </AccordionHeader>
            <AccordionBody stayOpen={args.stayOpen}>
                {ipsum()}
            </AccordionBody>
        </AccordionItem>
        <AccordionItem>
